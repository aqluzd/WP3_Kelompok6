        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="panel panel-info">
                    <div class="panel-heading"><h3 class="text-center"><b>Asep </b></small> Car Rent</small></h3></div>
                    <div class="panel-body">
                        <form action="<?=$_SERVER['REQUEST_URI']?>" method="POST">
                            ...
                            <a button href="index.php" class="btn btn-info btn-block">Kembali</a button> 
                        </form>
                    </div>
